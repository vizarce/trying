...
public class CryptoCurrency implements java.io.Serializable, Comparable<CryptoCurrency> {
	...
	public static class Data {
		...
		public static class CurrencyType {
			...
			public CurrencyType() {}
			public CurrencyType(String name, String symbol, double supply, String coin_market_price, String coin_cap_price, String coin_market_volume, String coin_cap_volume) {
				this.name = name;
				this.symbol = symbol;
				this.supply = supply;
			...
			public int hashCode() {
				...
				long supplyLong = Double.doubleToLongBits(supply);
        		result = 31 * result + (int) (supplyLong ^ (supplyLong >>> 32));
